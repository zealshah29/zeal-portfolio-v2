...
const AndroidMenuWork: FunctionComponent<AndroidMenuWorkType> = ({
  className = "",
  onClose,
}) => {
  ...
  return (
    ...
    >
      ...
      <b className="absolute top-[364px] left-[150px] text-dodgerblue">WORK</b>
      <div
...
export default AndroidMenuWork;